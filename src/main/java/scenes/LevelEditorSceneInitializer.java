...
public class LevelEditorSceneInitializer extends SceneInitializer {
    ...
    public Spritesheet city_sprite, enemy, world;
    ...
    public void init(Scene scene) {
        city_sprite = AssetPool.getSpritesheet("assets/images/spritesheets/decorationsAndBlocks.png");

        enemy = AssetPool.getSpritesheet("assets/tilemap_packed.png");

        world = AssetPool.getSpritesheet("assets/tilemap_packed.png");
    ...
    public void loadResources(Scene scene) {
        ...
        //AssetPool.addSpritesheet("assets/tilemap_packed.png",enemy);
    ...
    public void imgui() {
        ...
        if (ImGui.beginTabBar("WindowTabBar")) {
            if (ImGui.beginTabItem("Solid Blocks")) {
                ...
                for (int i = 0; i < city_sprite.size(); i++) {
                    if (i == 34) continue;
                    if (i >= 38 && i < 61) continue;

                    Sprite sprite = city_sprite.getSprite(i);
                    ...
                    if (i + 1 < city_sprite.size() && nextButtonX2 < windowX2) {
                        ImGui.sameLine();
                    }
                }
            ...
            // todo :
            if (ImGui.beginTabItem("City Blocks")) {
                ...
                for (int i = 0; i < enemy.size(); i++) {
                    ...
                    Sprite sprite = enemy.getSprite(i);
                    float spriteWidth = sprite.getWidth() * 4;
                    float spriteHeight = sprite.getHeight() * 4;
                    int id = sprite.getTexId();
                    Vector2f[] texCoords = sprite.getTexCoords();
...
/*                        if (i == 12) {
                    ...
                    float lastButtonX2 = lastButtonPos.x;
                    float nextButtonX2 = lastButtonX2 + itemSpacing.x + spriteWidth;
                    if (i + 1 < enemy.size() && nextButtonX2 < windowX2) {
                        ImGui.sameLine();
                    }
                }
            ...
            if (ImGui.beginTabItem("Decoration City Blocks")) {
...
/*                        if (i == 12) {
                    ...
                    float lastButtonX2 = lastButtonPos.x;
                    float nextButtonX2 = lastButtonX2 + itemSpacing.x + spriteWidth;
                    if (i + 1 < world.size() && nextButtonX2 < windowX2) {
                        ImGui.sameLine();
                    }
                }
            ...
            if (ImGui.beginTabItem("Breakable City Blocks")) {
            ...
            if (ImGui.beginTabItem("Prefabs")) {
                ...
                // todo :
                Spritesheet new_sprite = AssetPool.getSpritesheet("assets/tilemap_packed.png");
                sprite = new_sprite.getSprite(188);
                id = sprite.getTexId();
                texCoords = sprite.getTexCoords();

                ImGui.pushID(uid++);
                if (ImGui.imageButton(id, spriteWidth, spriteHeight, texCoords[2].x, texCoords[0].y, texCoords[0].x, texCoords[2].y)) {
                    GameObject object = Prefabs.generateMonsterChar();
                    levelEditorStuff.getComponent(MouseControls.class).pickupObject(object);
                }
                ImGui.popID();
                ImGui.sameLine();
                // todo :
                Spritesheet new_sprite_two = AssetPool.getSpritesheet("assets/tilemap_packed.png");
                sprite = new_sprite.getSprite(267);
                id = sprite.getTexId();
                texCoords = sprite.getTexCoords();

                ImGui.pushID(uid++);
                if (ImGui.imageButton(id, spriteWidth, spriteHeight, texCoords[2].x, texCoords[0].y, texCoords[0].x, texCoords[2].y)) {
                    GameObject object = Prefabs.generateBlackChar();
                    levelEditorStuff.getComponent(MouseControls.class).pickupObject(object);
                }
                ImGui.popID();
                ImGui.sameLine();
                ...
                // todo :
                Spritesheet new_sprite_three = AssetPool.getSpritesheet("assets/tilemap_packed.png");
                sprite = new_sprite.getSprite(266);
                id = sprite.getTexId();
                texCoords = sprite.getTexCoords();

                ImGui.pushID(uid++);
                if (ImGui.imageButton(id, spriteWidth, spriteHeight, texCoords[2].x, texCoords[0].y, texCoords[0].x, texCoords[2].y)) {
                    GameObject object = Prefabs.generateNewSrpite();
                    levelEditorStuff.getComponent(MouseControls.class).pickupObject(object);
                }
                ImGui.popID();
                ImGui.sameLine();
                ...
                // todo :
                Spritesheet my_sprite = AssetPool.getSpritesheet("assets/tilemap_packed.png");
                sprite = new_sprite.getSprite(26);
                id = sprite.getTexId();
                texCoords = sprite.getTexCoords();

                ImGui.pushID(uid++);
                if (ImGui.imageButton(id, spriteWidth, spriteHeight, texCoords[2].x, texCoords[0].y, texCoords[0].x, texCoords[2].y)) {
                    GameObject object = Prefabs.generateSmartChar();
                    levelEditorStuff.getComponent(MouseControls.class).pickupObject(object);
                }
                ImGui.popID();
                ImGui.sameLine();
