    ...
    public void update(float dt) {
        if (playWinAnimation) {
            ...
            if (!onGround) {
                ...
                if (!AssetPool.getSound("assets/Sound/game_penny.wav").isPlaying()) {   // assets/sounds/stage_clear.ogg"
                    AssetPool.getSound("assets/Sound/game_penny.wav").play(); // assets/sounds/stage_clear.ogg
                }
                timeToCastle -= dt;
                walkTime -= dt;
